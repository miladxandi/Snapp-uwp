...
namespace SnappApp.Views
{
    public sealed partial class WebViewPage : Page, INotifyPropertyChanged
    {
        ...
        private const string DefaultUrl = "https://app.snapp.ir";
        private const string myUrl = "https://miladzandi.ir";
        ...
        private async void OnOpenInBrowser(object sender, RoutedEventArgs e)
        {
            ...
            await Windows.System.Launcher.LaunchUriAsync(uriMe);
        }
